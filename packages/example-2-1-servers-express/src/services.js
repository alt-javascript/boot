/**
 * example-2-1-servers-express — services
 *
...
export class GreetingService {
  static qualifier = '@alt-javascript/example-2-1-servers-express/GreetingService';
...
export class Application {
  static qualifier = '@alt-javascript/example-2-1-servers-express/Application';
