/**
 * example-3-1-intro-fastify — services
 *
 * Identical CDI patterns to example-2-1-intro-express.
 * The framework adapter changes; the service layer doesn't.
 */

export class GreetingService {
  static qualifier = '@alt-javascript/example-3-1-intro-fastify/GreetingService';
...
export class Application {
  static qualifier = '@alt-javascript/example-3-1-intro-fastify/Application';
