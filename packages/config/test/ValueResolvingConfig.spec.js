...
describe('ValueResolvingConfig Specification', () => {
  ...
  it('config nested.encrypted == enc.MrfGVtwBex9JZoTRIC6/KtpET4gJkJ/U', () => {
    ...
    assert.equal(config.get('nested.encryptedWithSecret2'), 'ENC(/emLGkD3cbfqoSPijGZ0jh1p1SYIHQeJ)', 'config nested.key == enc.MrfGVtwBex9JZoTRIC6/KtpET4gJkJ/U');
    assert.equal(config.get('nested.encryptedWithSecret3'), 'eNc(/emLGkD3cbfqoSPijGZ0jh1p1SYIHQeJ)', 'config nested.key == enc.MrfGVtwBex9JZoTRIC6/KtpET4gJkJ/U');
