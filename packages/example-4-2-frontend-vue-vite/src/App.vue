 ...
 *
 * CDI beans are injected via Vue's inject() — provided by vueStarter().
 * No prop drilling, no Vuex/Pinia required for CDI-managed services.
 */
...
<template>
  <div class="app">
    ...
    <p class="subtitle">
      CDI beans injected via <code>inject('todoService')</code>.
      Config loaded from <code>config/application.json</code>.
    </p>
