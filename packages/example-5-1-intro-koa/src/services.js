/**
 * example-5-1-intro-koa — services
 *
...
export class GreetingService {
  static qualifier = '@alt-javascript/example-5-1-intro-koa/GreetingService';
...
export class Application {
  static qualifier = '@alt-javascript/example-5-1-intro-koa/Application';
